            ...
            <div className="border-t border-r border-border px-3 py-2 bg-background">
              <div className="flex items-center gap-1">
                ...
                <Button
                  ...
                  onClick={toggleTheme}
                  aria-label={t(theme === "dark" ? "layout.switchToLight" : "layout.switchToDark")}
                  title={t(theme === "dark" ? "layout.switchToLight" : "layout.switchToDark")}
                >
                ...
                <Button
                  ...
                  variant="ghost"
                  size="icon-sm"
                  className="text-muted-foreground shrink-0 text-xs font-medium w-auto px-1.5"
